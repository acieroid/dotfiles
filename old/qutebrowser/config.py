#! /usr/bin/env python
# -*- coding: utf-8 -*-
# found here: https://raw.githubusercontent.com/sheoak/dotfiles-bepoptimist/master/.config/qutebrowser/config.py
download_path = '~/Downloads'
yt_download_cmd = "yt-dlp -o '" + download_path \
        + "/%(title)s.%(ext)s'"
